...
public class ScienceFictionBook extends FictionBook {

	private String subsection;
	
	public ScienceFictionBook() { }
	
	public ScienceFictionBook (String title, String author, int year, double price, String genre, String subsection) {
	...
	public String toString() {
		...
		+ ", year=" + getYear() + ", price=" + getPrice() + ", genre=" + getGenre() + ", subsection= " + subsection + "]");
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScienceFictionBook other = (ScienceFictionBook) obj;
		if (subsection == null) {
